...
@export var pan_name: String = "beans_pot"
@export var output_ingredient_name: String = "cooked_beans"
@export var serving_amount: int = 4
...
var States = {
	...
	"PastaState": {
		"on_ingredient_added":
			func(ingredient_name):
				if(ingredient_name == "water"):
					_switch_to_state("PastaAndWaterState"),
	},
	"WaterState": {
		"on_fire_start":
			func():
	...
	"BeansAndWaterState": {
		"on_fire_start":
			func():
				_switch_to_state("CookingBeansState")
				_audio.stream = _on_cooking_audio_loop
				_audio.play(),
		"on_fire_stop":
			func():
	...
	"CookingBeansState": {
		...
		"on_timer_timeout":
			func():
				_switch_to_state("CookedBeansState"),
	},
	"CookingRiceState": {
		"timer_wait": 14,
		"on_fire_start":
		...
		"on_timer_timeout":
			func():
				_switch_to_state("CookedRiceState"),
	},
	"CookingPastaState": {
		"timer_wait": 14,
		"on_fire_start":
		...
		"on_timer_timeout":
			func():
				_switch_to_state("CookedPastaState"),
	},
	"CookedBeansState": {
		"timer_wait": 6,
		"on_state_enter":
		...
		"on_timer_timeout":
			func():
				_switch_to_state("OvercookedBeansState"),
		"on_fire_stop":
			func():
				_audio.stop()
				_timer.stop(),
	...
	"CookedRiceState": {
		...
		"on_timer_timeout":
			func():
				_switch_to_state("OvercookedRiceState"),
		"on_fire_stop":
			func():
				_audio.stop()
				_timer.stop(),
	...
	"CookedPastaState": {
		...
		"on_timer_timeout":
			func():
				_switch_to_state("OvercookedPastaState"),
		"on_fire_stop":
			func():
				_audio.stop()
				_timer.stop(),
